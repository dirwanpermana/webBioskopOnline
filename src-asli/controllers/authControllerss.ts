...
// jika data benar nanti di compare password pake bcrypt dan butuh json web token
        const comparePassword = bcrypt.compareSync(parse.password, checkUser.password); //compare password yg di input dgn password database checkUser
        ...
        const token = jwt.sign(
            ...
            secretKey,
            {expiresIn: "7d"}, //expired 24h ganti jadi 7 day
        );
