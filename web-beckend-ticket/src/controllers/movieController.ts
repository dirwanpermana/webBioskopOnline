...
export const createMovie = async (req: Request, res: Response) => {
  try {
    ...
    // karena nanti upload nya lewat multer data request nya berbentuk form data bukan bentuk json. maka fungsi zod di midleware bakalan ga jalan karena si validate itu hanya jalan kalo data nya json. maka dari itu perlu melakukan validasi di controller nya langsung
    ...
    // save movies dan balikin success atau error
    await movie.save();
